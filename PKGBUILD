# Contributor: Johnny Halfmoon <jhalfmoon@milksnot.com>
...
pkgrel=1
pkgdesc="Mips Harvard Os161 GDB is a branch of FSF GDB that contains Mips focused features for the OS 161 Harvard course."
arch=(i686 x86_64)
...
#provides=('mips-harvard-os161-gdb')
#conflicts=('mips-harvard-os161-gdb')
